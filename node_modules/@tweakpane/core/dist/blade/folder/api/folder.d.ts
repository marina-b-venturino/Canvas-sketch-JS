...
export declare class FolderApi extends ContainerBladeApi<FolderController> implements ContainerApi {
     ...
     */
    on<EventName extends keyof FolderApiEvents>(eventName: EventName, handler: (ev: FolderApiEvents[EventName]) => void): FolderApi;
}
